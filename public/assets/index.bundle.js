...
/***/ function(module, exports, __webpack_require__) {
	...
	//  );
	ReactDOM.render(React.createElement(Login, { url: '/users/create-identity' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({
		...
		handleAClick: function handleAClick(e) {
			var target = e.target,
			    formState = 0;
			if (this.state.formState === 0) formState = 1;
		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement("input", { type: "hidden", name: "formState", value: this.state.formState }),
				React.createElement(
					"ul",
					null,
					React.createElement(
						"li",
						null,
						React.createElement("input", { type: "text", name: "identity", placeholder: "请输入标识" }),
						React.createElement(
							"a",
							{ href: "javascript:void(0)", onClick: this.handleAClick },
							content.text
						)
					),
					React.createElement(
						"li",
						null,
						React.createElement("input", { type: "submit", value: content.value }),
						React.createElement("span", { ref: "msg" })
					)
				)
			);
		}
