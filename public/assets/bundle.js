...
/***/ function(module, exports, __webpack_require__) {
	...
	//  );
	ReactDOM.render(React.createElement(Login, { url: '/users/create-identity' }), document.getElementById('login'));
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						"li",
						null,
						React.createElement("input", { type: "submit", value: formState[this.state.formState] })
					)
				)
			);
		}
